...
**How to apply:** Preserve the paired type and number for standard and approved project-specific instrument codes; keep a raw summary row so spreadsheet users can filter each field independently.