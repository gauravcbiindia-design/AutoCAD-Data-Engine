...
export const RAW_COLUMNS = [
  ...
  "X", "Y", "Attribute_Tag", "Attribute_Value", "Raw_Text", "Detected_Type", "Ref",
] as const;
...
export function buildRawCsvString(result: ExtractionResult): string {
  ...
  const ALWAYS_KEEP = new Set(["OPC", "INSTRUMENTS", "EQUIPMENT", "STREAM", "COMPONENTS", "VALVES", "ALARM", "INTERLOCK"]);
